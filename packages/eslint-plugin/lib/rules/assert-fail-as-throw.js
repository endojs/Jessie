 ...
 * 
 * Modified by Michael FIG <mfig@agoric.com> for SES's assert.fail.
...
module.exports = {
    meta: {
        docs: {
            ...
            recommended: true,
            url:
                "https://github.com/endojs/Jessie/blob/master/packages/eslint-plugin/lib/rules/assert-fail-as-throw.js",
        },
        type: "problem",
        fixable: null,
        schema: [],
